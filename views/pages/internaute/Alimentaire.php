...
<body>
        ...
        <div class="col-9 collapse navbar-collapse navbar-expand-md">
            <nav>
                ...
                <ul class="navbar-nav  nav-pills">
                    ...
                    <li class="nav-item active"><a class="align nav-link" href="Alimentaire.php">Alimentaires</a></li>
                </ul>
            </nav>
    ...
    <div class="container mb-5">
        <h1 class = "text-center text-primary">
            BIENVENUE SUR LA PAGE DES PRODUITS ALIMENTAIRES
        </h1>
    </div>
    <section class="container-fluid mb-4">
        <main class="row">
            <?php 
                ...
                $resultat->execute(array('alimentaire'));
